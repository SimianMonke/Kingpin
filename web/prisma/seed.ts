...
async function main() {
  ...
  // ==========================================================================
  // SEED CONSUMABLE TYPES (Supply Depot)
  // ==========================================================================
  console.log('Seeding consumable types...')

  const consumableTypes = await Promise.all([
    // XP Boosters
    prisma.consumable_types.upsert({
      where: { id: 'xp_25' },
      update: {},
      create: {
        id: 'xp_25',
    ...
    prisma.consumable_types.upsert({
      ...
      create: {
        ...
        flavor_text: 'Military-grade cognitive enhancement. Side effects include mild euphoria.',
        icon: 'brain',
        sort_order: 2,
      },
    }),
